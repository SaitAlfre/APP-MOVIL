    ...
    private function reglasCambio(string $entidad): array
    {
        ...
        return match ($entidad) {
            ...
            'calidad' => ['uuid' => ['required', 'string', 'max:64'], 'proveedorId' => ['nullable', 'integer'], 'proveedorCodigo' => ['required', 'string', 'max:60'],
                'codigoMuestra' => ['nullable', 'string', 'max:40'], 'loteRecipiente' => ['nullable', 'string', 'max:60'], 'volumenL' => ['nullable', 'numeric'],
                'origenCaptura' => ['nullable', 'string', 'in:MANUAL,ESCANER'], 'serialAnalizador' => ['nullable', 'string', 'max:60'],
                'modoAnalizador' => ['nullable', 'string', 'max:60'],
                ...collect(['temperatura', 'grasa', 'sng', 'densidad', 'proteina', 'lactosa', 'sales', 'solidosTotales', 'aguaAnadida', 'puntoCongelacion', 'ph'])
                    ->mapWithKeys(fn (string $campo) => [$campo => ['nullable', 'numeric']])->all(),
                'apariencia' => ['nullable', 'string', 'max:255'], 'observaciones' => ['nullable', 'string', 'max:2000'],
                'estado' => ['required', 'string', 'in:APROBADO,OBSERVADO,RECHAZADO,REPETIR'], 'alertas' => ['nullable', 'array'], 'alertas.*' => ['string', 'max:500'],
                'textoComprobante' => ['nullable', 'string', 'max:20000'], 'visita' => ['nullable', 'array'],
